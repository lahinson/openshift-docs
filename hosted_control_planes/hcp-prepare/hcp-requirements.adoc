...
* xref:../../hosted_control_planes/hosted-control-planes-release-notes.adoc#hcp-tech-preview-features_hosted-control-planes-release-notes[{hcp-capital} release notes]
