...
[role="_abstract"]
By using the {oadp-first} Operator for disaster recovery, you can restore hosted cluster namespaces from object storage instead of manually rebuilding every cluster. In addition, you back up etcd by using CSI volume snapshots, and you can back up hosted clusters independently.
