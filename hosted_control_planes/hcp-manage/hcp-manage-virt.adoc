...
[NOTE]
====
In {hcp} on {VirtProductName}, {VirtProductName} handles storage on hosted clusters, which especially helps customers whose requirements are limited to block storage.
====
